...
当前阶段：V0.9.4 Scaffold Docs / README Generator。
...
- Scaffold Agent Template（V0.9.2）：scripts/scaffold_agent.py，从 templates/agent-template/ 读取源模板，生成 templates/<name>/ 下的 agent.json + README.md。10 条测试
- Scaffold Eval Cases（V0.9.3）：scripts/scaffold_eval.py，生成 evals/cases/<name>.json，匹配 run_evals.py 的 13 个 REQUIRED_FIELDS 和 eval-case.schema.json。使用 demo_agent module。复用命名校验
