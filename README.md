...
> 当前阶段 V1.1 为 Multi-user Runtime Contract。UserContext / Conversation /
> Message / RunBinding 合同已定义。CreateRunRequest 支持可选 user context。
> 只是 contract 阶段——不做 auth、RBAC、tenant enforcement。
