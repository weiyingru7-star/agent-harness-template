        ...
        with session_scope() as session:
            ...
            for node_trace in result.steps:
                ...
                if node_trace.name == "tool_node":
                    ...
                    perm_denied = False
                    effective_permission_level = (tool_definition.permission_level if tool_definition else "safe")
                    effective_allowed_contexts = tool_definition.allowed_contexts if tool_definition else None
                    run_context = "demo"
                    ...
                    if perm_denied:
                        ...
                        effective_execution_mode = (tool_definition.execution_mode if tool_definition else "in_process")
